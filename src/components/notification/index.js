export class NotificationMessage {
  ...
  get template () {
    return this.prepareTemplate`<div class="notification" style="--value:${this.durationInSeconds}">
      <div class="timer"></div>
...
export class ErrorNotificationMessage extends NotificationMessage {
  get template () {
    return this.prepareTemplate`<div class="notification error">
      <div class="inner-wrapper">
...
export class WarningNotificationMessage extends NotificationMessage {
  get template () {
    return this.prepareTemplate`<div class="notification warning" style="--value:${this.durationInSeconds}">
      <div class="timer"></div>
      <div class="inner-wrapper">
